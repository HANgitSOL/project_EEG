...
eeg_file = fullfile(data_path, sub_id, [sub_id '_decoder-distractor-second.eeg']);
event_file = fullfile(data_path, sub_id, [sub_id '_events-bst_main.mat']);
proj_file = fullfile(data_path, sub_id, [sub_id '_projection-ssp_main.mat']);
